...
<blockquote>
  <p>1. 스트림은 요소를 저장하지 않습니다. 요소는 스트림을 지원하는 컬렉션에 저장되거나 필요한 때에 생성됩니다.</p>  
  <p>2. 스트림 연산은 원본을 변경하지 않습니다. <strong>Immutable</strong> 합니다.</p> 
  <p>3. 스트림 연산은 가능하면 지연시켜 둡니다. 즉 연산 결과가 필요하기 전까지는 실행되지 않습니다.</p>
</blockquote>
